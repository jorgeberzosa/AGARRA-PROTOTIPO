...
export const films: Film[] = [
  ...
  },
  {
    ...
    synopsis: "After fleeing a convent out of fear of her father, Amparo arrives in a marginalized neighborhood in Medellín. She is soon abducted and forced to live with 'The Animal'. Through sheer resilience, she fights to break the cycle of abuse and save her daughter.",
    shortDescription: "A young woman fights for survival after being abducted in a marginalized neighborhood.",
    whyItMatters: "A raw, painfully realistic cinematic portrayal of violence and survival.",
