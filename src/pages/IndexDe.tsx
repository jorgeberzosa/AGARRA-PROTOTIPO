...
import { films, articles, events, IMAGES } from "@/lib/dataDe";
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
          ...
          <div>
            <div className="inline-flex items-center gap-2 bg-[#C8A97E]/10 border border-[#C8A97E]/20 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-xs text-[#C8A97E] font-medium">
                Iberoamerikanisches Independent-Kino
              </span>
            </div>
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-[#F5F0EB] leading-[1.05] tracking-tight">
              ...
              <span className="text-[#C8A97E] italic">Live-Kanal</span>
            </h1>

            <p className="mt-6 text-lg text-[#9A9590] leading-relaxed max-w-lg">
              AGARRA ist eine kuratierte Plattform, auf der Independent-Kino auf die Community trifft. Sieh dir Filme an, nimm an Live-Events teil und erhalte Belohnungen.
            </p>
            ...
            <div className="mt-12 flex items-center gap-8 text-sm text-[#9A9590]">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>+18K Mitglieder</span>
              </div>
              <div className="flex items-center gap-2">
                <Calendar size={16} className="text-[#C8A97E]" />
                <span>Wöchentliche Events</span>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <SectionHeader
          title="Warum AGARRA?"
          subtitle="Mehr als nur Streaming. Ein lebendiges Ökosystem für Independent-Kino."
        />
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              icon: <Eye size={28} />,
              title: "Kuratiertes Independent-Kino",
              description:
                "Jeder Film ist handverlesen aufgrund seines künstlerischen Werts. Keine Algorithmen — nur guter Geschmack.",
            },
            {
              icon: <Heart size={28} />,
              title: "Live-Zuschauerbeteiligung",
              description:
                "Schließe dich Watch-Partys und Live-Q&As mit Regisseuren an. Kino wird zu einem sozialen Erlebnis.",
            },
            {
              icon: <Wallet size={28} />,
              title: "Belohnungen & Zugang",
              description:
                "Sammle Sammlerstücke und schalte exklusiven Zugang frei. Deine Teilnahme hat echten Wert.",
            },
          ].map((feature) => (
            <div
              key={feature.title}
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <SectionHeader
          title="Live-Kanäle"
          subtitle="Aktive Communities mit Events, Belohnungen und vielen Diskussionen."
          action="Ansehen canales"
          actionLink="/explore"
        />
      ...
      <section className="py-24 bg-[#0E0E0E]">
        <div className="max-w-7xl mx-auto px-6">
          <SectionHeader
            ...
            subtitle="Drei einfache Schritte zur AGARRA-Erfahrung."
          />
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <SectionHeader
          title="Próximos Events"
          subtitle="Live-Q&As, Watch-Partys und Panel-Diskussionen diese Woche."
        />
        <div className="grid md:grid-cols-3 gap-6">
          {events.map((event) => (
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <SectionHeader
          title="Aus dem Magazin"
          subtitle="Interviews, Festivalberichte und kritische Perspektiven zum Independent-Kino."
          action="Mehr lesen"
          actionLink="/journal"
        />
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-display text-4xl md:text-5xl font-bold text-[#F5F0EB] leading-tight">
            ...
            <span className="text-[#C8A97E] italic">geteilt wird</span>
          </h2>
          <p className="mt-6 text-lg text-[#9A9590] max-w-2xl mx-auto leading-relaxed">
            Treten Sie AGARRA bei und werden Sie Teil einer Community, die unabhängiges Geschichtenerzählen schätzt.
          </p>
